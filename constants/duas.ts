    ...
    duas: [
      {
        ...
        transliteration:
          "Allahumma anta rabbee laa ilaaha illa ant, khalaqtanee wa anaa 'abduk, wa anaa 'alaa 'ahdika wa wa'dika masta-ta't, a'oothu bika min sharri maa sana't, aboo'u laka bini'matika 'alayya, wa aboo'u bithanbee faghfir lee, fa'innahoo laa yaghfiruth-thunooba illa ant",
        meaning:
    ...
    duas: [
      {
        ...
        meaning:
          "O Allah, I seek refuge in You from grief and sadness, from weakness and from laziness, from miserliness and from cowardice, from being overcome by debt and from oppression of men.",
